...
func (w *wrappedCompanySystemServer) DeleteCompany(ctx golang_org_x_net_context.Context, req *DeleteCompanyRequest) (res *DeleteCompanyResponse, err error) {
	ctx, err = elbix_dev_engine_pkg_grpcgw.ExecuteMiddleware(ctx, w.original)
	if err != nil {
		return nil, err
	}
	...
	res, err = w.original.DeleteCompany(ctx, req)
	return
}
